...
const AdminSidebar = ({ className }: AdminSidebarProps) => {
  return (
    <aside
      className={`rounded-3xl bg-black py-6 px-4 ${className} self-start sticky top-4 min-w-[60px]`}
    >
      <nav>
        <ul className="flex flex-col items-center justify-center gap-y-10 h-full">
          ...
          <li>
            <NavLink
              to="/admin/users"
              className="active:scale-125 block hover:scaleH-125 transition-transform ease duration-300 aria-[current=page]:scale-125"
            >
